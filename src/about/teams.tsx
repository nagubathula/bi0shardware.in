...
const Teams = () => (
    <section id="teams" className="py-8">
        <h2 className="font-semibold font-jetbrains highlight text-xl md:text-2xl mb-4 lg:text-3xl xl:text-4xl">
            Our Teams
        </h2>
        ...
        <div className="flex flex-wrap mx-0 my-4">
            {TEAMS.map((t) => (
                <div className="w-full md:w-1/2 py-6 px-3" key={t.name}>
                    <div className="text-lg font-jetbrains  md:text-xl lg:text-2xl font-semibold mb-2">
                        {t.name}
                    </div>
